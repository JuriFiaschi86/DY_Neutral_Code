...
int main(int argc, char** argv)
{
    ...
    double uubarEF;
    text = "listuubcutEFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double uubarEB;
    text = "listuubcutEBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double uubarOF;
    text = "listuubcutOFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double uubarOB;
    text = "listuubcutOBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ubaruEF;
    text = "listubucutEFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ubaruEB;
    text = "listubucutEBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ubaruOF;
    text = "listubucutOFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ubaruOB;
    text = "listubucutOBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ddbarEF;
    text = "listddbcutEFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ddbarEB;
    text = "listddbcutEBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ddbarOF;
    text = "listddbcutOFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double ddbarOB;
    text = "listddbcutOBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double dbardEF;
    text = "listdbdcutEFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double dbardEB;
    text = "listdbdcutEBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double dbardOF;
    text = "listdbdcutOFeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
    ...
    begin = std::chrono::steady_clock::now();
    double dbardOB;
    text = "listdbdcutOBeigen[" + eta_cut_s + ", " + pT_cut_s + "][" + energy_s + "] = {{";
