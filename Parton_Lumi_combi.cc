...
//// Seems like these PDFs have a threshold at x=9.908496e-01.
//// I have to impose a cut to avoid LHAPDF to crush

#define high_x_threshold 9.908496e-01

#define setname "high_x_var"
// 0  // #define setname "high_x_var_Central"
// 1  // #define setname "high_x_var_Dsea_B_03minus"
// 2  // #define setname "high_x_var_Dsea_B_03plus"
// 3  // #define setname "high_x_var_Dsea_B_05minus"
// 4  // #define setname "high_x_var_Dsea_B_05plus"
// 5  // #define setname "high_x_var_Dsea_B_10minus"
// 6  // #define setname "high_x_var_Dsea_B_10plus"
// 7  // #define setname "high_x_var_Dv_B_03minus"
// 8  // #define setname "high_x_var_Dv_B_03plus"
// 9  // #define setname "high_x_var_Dv_B_05minus"
// 10 // #define setname "high_x_var_Dv_B_05plus"
// 11 // #define setname "high_x_var_Dv_B_10minus"
// 12 // #define setname "high_x_var_Dv_B_10plus"
// 13 // #define setname "high_x_var_Usea_B_03minus"
// 14 // #define setname "high_x_var_Usea_B_03plus"
// 15 // #define setname "high_x_var_Usea_B_05minus"
// 16 // #define setname "high_x_var_Usea_B_05plus"
// 17 // #define setname "high_x_var_Usea_B_10minus"
// 18 // #define setname "high_x_var_Usea_B_10plus"
// 19 // #define setname "high_x_var_Uv_B_03minus"
// 20 // #define setname "high_x_var_Uv_B_03plus"
// 21 // #define setname "high_x_var_Uv_B_05minus"
// 22 // #define setname "high_x_var_Uv_B_05plus"
// 23 // #define setname "high_x_var_Uv_B_10minus"
// 24 // #define setname "high_x_var_Uv_B_10plus"

// VARIATION 0
#define PDF_set_u 0
#define PDF_set_ubar 0
#define PDF_set_d 0
#define PDF_set_dbar 0
#define combination "central"

// // VARIATION -0.3
// #define PDF_set_u 19
// #define PDF_set_ubar 13
// #define PDF_set_d 7
// #define PDF_set_dbar 1
// #define combination "03minus"
// 
// // VARIATION +0.3
// #define PDF_set_u 20
// #define PDF_set_ubar 14
// #define PDF_set_d 8
// #define PDF_set_dbar 2
// #define combination "03plus"
// 
// // VARIATION -0.5
// #define PDF_set_u 21
// #define PDF_set_ubar 15
// #define PDF_set_d 9
// #define PDF_set_dbar 3
// #define combination "05minus"
// 
// // VARIATION +0.5
// #define PDF_set_u 22
// #define PDF_set_ubar 16
// #define PDF_set_d 10
// #define PDF_set_dbar 4
// #define combination "05plus"
// 
// // VARIATION -1.0
// #define PDF_set_u 23
// #define PDF_set_ubar 17
// #define PDF_set_d 11
// #define PDF_set_dbar 5
// #define combination "10minus"
// 
// // VARIATION +1.0
// #define PDF_set_u 24
// #define PDF_set_ubar 18
// #define PDF_set_d 12
// #define PDF_set_dbar 6
// #define combination "10plus"
// 
// // VARIATION maximal - minus (quark -1.0, antiquark +1.0)
// #define PDF_set_u 23
// #define PDF_set_ubar 18
// #define PDF_set_d 11
// #define PDF_set_dbar 6
// #define combination "maximal_minus"
// 
// // VARIATION maximal - plus (quark +1.0, antiquark -1.0)
// #define PDF_set_u 24
// #define PDF_set_ubar 17
// #define PDF_set_d 12
// #define PDF_set_dbar 5
// #define combination "maximal_plus"
...
double uubarEF_funct (double yreduced, void * params) {
    ...
    double Minv = (p->Minv);
    int PDF_set_q = (p->PDF_set_q);
    int PDF_set_qbar = (p->PDF_set_qbar);
...
//     double f2cbar = (pdf[PDF_set]->xfxQ(-4, x2, Q))/x2;
    ...
    // Partons PDFs with control
    double f1u, f1c, f2ubar, f2cbar, uubar_PDF;
    
    if ((x1 > high_x_threshold) || (x2 > high_x_threshold)) uubar_PDF = 0.0;
    else {
        
        f1u = (pdf[PDF_set_q]->xfxQ(2, x1, Q))/x1;
        f1c = (pdf[PDF_set_q]->xfxQ(4, x1, Q))/x1;
        f2ubar = (pdf[PDF_set_qbar]->xfxQ(-2, x2, Q))/x2;
        f2cbar = (pdf[PDF_set_qbar]->xfxQ(-4, x2, Q))/x2;
    
        uubar_PDF = f1u*f2ubar + f1c*f2cbar;
    }
...
double integration_uubarEF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
    ...
    p.Minv = Minv;
    p.PDF_set_q = PDF_set_q;
    p.PDF_set_qbar = PDF_set_qbar;
...
double integration_uubarEB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_uubarOF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_uubarOB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
//     double ubaru_PDF = f1ubar*f2u + f1cbar*f2c;
    ...
    // Partons PDFs with control
    double f1ubar, f1cbar, f2u, f2c, ubaru_PDF;
    
    if ((x1 > high_x_threshold) || (x2 > high_x_threshold)) ubaru_PDF = 0.0;
    else {
        
        f1ubar = (pdf[PDF_set_qbar]->xfxQ(-2, x1, Q))/x1;
        f1cbar = (pdf[PDF_set_qbar]->xfxQ(-4, x1, Q))/x1;
        f2u = (pdf[PDF_set_q]->xfxQ(2, x2, Q))/x2;
        f2c = (pdf[PDF_set_q]->xfxQ(4, x2, Q))/x2;
    
        ubaru_PDF = f1ubar*f2u + f1cbar*f2c;
    }
...
double integration_ubaruEF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_ubaruEB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_ubaruOF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_ubaruOB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
//     double ddbar_PDF = f1d*f2dbar + f1s*f2sbar + f1b*f2bbar;
    ...
    // Partons PDFs with control
    double f1d, f1s, f1b, f2dbar, f2sbar, f2bbar, ddbar_PDF;
    
    if ((x1 > high_x_threshold) || (x2 > high_x_threshold)) ddbar_PDF = 0.0;
    else {
        
        f1d = (pdf[PDF_set_q]->xfxQ(1, x1, Q))/x1;
        f1s = (pdf[PDF_set_q]->xfxQ(3, x1, Q))/x1;
        f1b = (pdf[PDF_set_q]->xfxQ(5, x1, Q))/x1;
        f2dbar = (pdf[PDF_set_qbar]->xfxQ(-1, x2, Q))/x2;
        f2sbar = (pdf[PDF_set_qbar]->xfxQ(-3, x2, Q))/x2;
        f2bbar = (pdf[PDF_set_qbar]->xfxQ(-5, x2, Q))/x2;

    // PDF combinations    
        ddbar_PDF = f1d*f2dbar + f1s*f2sbar + f1b*f2bbar;
    }
...
double integration_ddbarEF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_ddbarEB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_ddbarOF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_ddbarOB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
//     double dbard_PDF = f1dbar*f2d + f1sbar*f2s + f1bbar*f2b;
    ...
    // Partons PDFs with control
    double f1dbar, f1sbar, f1bbar, f2d, f2s, f2b, dbard_PDF;
    
    if ((x1 > high_x_threshold) || (x2 > high_x_threshold)) dbard_PDF = 0.0;
    else {
        
        f1dbar = (pdf[PDF_set_qbar]->xfxQ(-1, x1, Q))/x1;
        f1sbar = (pdf[PDF_set_qbar]->xfxQ(-3, x1, Q))/x1;
        f1bbar = (pdf[PDF_set_qbar]->xfxQ(-5, x1, Q))/x1;
        f2d = (pdf[PDF_set_q]->xfxQ(1, x2, Q))/x2;
        f2s = (pdf[PDF_set_q]->xfxQ(3, x2, Q))/x2;
        f2b = (pdf[PDF_set_q]->xfxQ(5, x2, Q))/x2;

        // PDF combinations    
        dbard_PDF = f1dbar*f2d + f1sbar*f2s + f1bbar*f2b;
    }
...
double integration_dbardEF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_dbardEB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_dbardOF_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
double integration_dbardOB_y (int PDF_set_q, int PDF_set_qbar, double Minv) {
...
int main(int argc, char** argv)
{
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            uubarEF = integration_uubarEF_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            uubarEB = integration_uubarEB_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            uubarOF = integration_uubarOF_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            uubarOB = integration_uubarOB_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ubaruEF = integration_ubaruEF_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ubaruEB = integration_ubaruEB_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ubaruOF = integration_ubaruOF_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ubaruOB = integration_ubaruOB_y(PDF_set_u, PDF_set_ubar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ddbarEF = integration_ddbarEF_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ddbarEB = integration_ddbarEB_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ddbarOF = integration_ddbarOF_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            ddbarOB = integration_ddbarOB_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            dbardEF = integration_dbardEF_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            dbardEB = integration_dbardEB_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            dbardOF = integration_dbardOF_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
    ...
    for (size_t PDF_set = 0; PDF_set <= nmem; PDF_set++) {
        ...
        for (int i = 0; i < points_Minv; i++) {
            ...
            dbardOB = integration_dbardOB_y(PDF_set_d, PDF_set_dbar, Minv_table[i]);
